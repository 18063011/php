  ...
  <body>
    ...
    <form action="" method="POST" enctype="multipart/form-data" class="mb-2">
      <div class="input-group w-90 mb-2">
        ...
        <input type="submit" class="btn btn-primary" name="submit" id="submit" value="Thêm danh mục">
    </form>
    <?php
    if(isset($_POST['submit'])&&$_POST['submit']){
      ...
      if($number>0){
        ...
        $insert_query="INSERT INTO `danhmuc` (tendanhmuc) VALUES ('$tendanhmuc')";
        $result_insert=mysqli_query($con,$insert_query);
        if($result_insert){
          echo "<script>alert('Danh mục được thêm vào thành công')</script>";
        }
      }
    }
    ?>
