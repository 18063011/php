...
if($number_update>0){
    while($row_update=mysqli_fetch_array($result)){
        $id_sach=$row_update['id_sach'];
        $tensach=$row_update['tensach'];
        $tacgia=$row_update['tacgia'];
        $gia=$row_update['gia'];
        $hinh=$row_update['hinh'];
    }
}
...
if(isset($_POST['submit'])&&$_POST['submit']){
    ...
    // Insert query
    $update_product="UPDATE `sach` SET id_sach=$id,tensach='$tensach',tacgia='$tacgia',id_danhmuc=$danhmuc,gia=$gia,hinh='$hinh_filename'
    WHERE id_sach=$id";
    }else{
      $update_product="UPDATE `sach` SET id_sach=$id,tensach='$tensach',tacgia='$tacgia',id_danhmuc=$danhmuc,gia=$gia
    WHERE id_sach=$id";
    }
    ...
    <div class="container mt-2">
        <form method="post" enctype="multipart/form-data">
            <div class="form-outline mb-3 w-50 m-auto">
                ...
                id="tensach" name="tensach" required="required" autocomplete="off"
                value="<?php echo $tensach; ?>">
            </div>
            <div class="form-outline mb-3 w-50 m-auto">
                <label for="tacgia" class="form-label">Tác giả</label>
                <input type="text" class="form-control" placeholder="Nhập tên tác giả" 
                id="tacgia" name="tacgia" required="required" autocomplete="off"
            ...
            <label for="danhmuc" class="form-label">Danh mục</label>
                <select name="danhmuc" id="danhmuc" class="form-select">
                  <?php
                      $select_query1="SELECT * FROM `danhmuc`";
            ...
            <div class="form-outline mb-3 w-50 m-auto">
                ...
                <input type="number" class="form-control" placeholder="Nhập giá (VNĐ)" 
                id="gia" name="gia" required="required" autocomplete="off"
                value="<?php echo $gia; ?>">
            </div>
            <div class="form-outline mb-3 w-50 m-auto">
            ...
            <div class="form-outline mb-3 w-50 m-auto">
                <input type="submit" class="btn btn-primary mb-3 px-3" id="submit" name="submit" value="Sửa sản phẩm">
            </div>
        </form>
    </div>
