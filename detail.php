      ...
      <section class="py-5">
        <div class="container">
          <div class="row mb-5">
            ...
            cart();
            ?>
              </div><a class="text-dark p-0 mb-4 d-inline-block" href="#"><i class="far fa-heart me-2"></i>Thêm vào yêu thích</a><br>
          ...
          <ul class="nav nav-tabs border-0" id="myTab" role="tablist">
            <li class="nav-item"><a class="nav-link text-uppercase active" id="description-tab" data-bs-toggle="tab" href="#description" role="tab" aria-controls="description" aria-selected="true">Mô tả</a></li>
            <li class="nav-item"><a class="nav-link text-uppercase" id="reviews-tab" data-bs-toggle="tab" href="#reviews" role="tab" aria-controls="reviews" aria-selected="false">Đánh giá</a></li>
          </ul>
          <div class="tab-content mb-5" id="myTabContent">
            <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
              <div class="p-4 p-lg-5 bg-white">
                <h6 class="text-uppercase">Mô tả sản phẩm </h6>
                <p class="text-muted text-sm mb-0">Một quyển sách tuyệt vời</p>
              </div>
            </div>
                  ...
                  <div class="col-lg-8">
                    <div class="d-flex mb-3">
                      ...
                      <div class="ms-3 flex-shrink-1">
                        ...
                        <p class="text-sm mb-0 text-muted">Quá đỉnh</p>
                      </div>
                    </div>
                    <div class="d-flex">
                      ...
                      <div class="ms-3 flex-shrink-1">
                        ...
                        <p class="text-sm mb-0 text-muted">Quá ghê gớm</p>
                      </div>
                    </div>
                  </div>
                </div>
